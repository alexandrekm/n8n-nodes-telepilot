...
export class TelePilotNodeConnectionManager {
	...
	private TD_DATABASE_PATH_PREFIX = process.env.TELEPILOT_DB_PATH || (process.env.HOME + "/.n8n/telepilot/db")
	private TD_FILES_PATH_PREFIX = process.env.TELEPILOT_FILES_PATH || (process.env.HOME + "/.n8n/telepilot/files")
